...
export const navGroups = [
  { title: 'Mentor Home', items: [['Dashboard','/dashboard','🏠'], ['Zero to Hero','/zero-to-hero','🏗️'], ['Final Premium','/final-premium','👑'], ['Premium Features','/premium-features','⚡']] },
  { title: 'Core', items: [['AI Mentor Agent','/ai-mentor','🤖'], ['Mentor Route','/mentor-route','🎯'], ['Focus Mode','/focus','✨'], ['Learning Coach','/learning-coach','📘']] },
...
const quickCommands = [
  ...
  { label: 'Zero to Hero Mentor', to: '/zero-to-hero', icon: '🏗️', kind: 'Command' },
  { label: 'Final Premium Automation', to: '/final-premium', icon: '👑', kind: 'Command' },
...
const localRoutes = [
  { words: ['zerohero','architect'], to: '/zero-to-hero', icon: '🏗️', group: 'Zero to Hero' },
  { words: ['finalpremium','automation'], to: '/final-premium', icon: '👑', group: 'Final Premium' },
