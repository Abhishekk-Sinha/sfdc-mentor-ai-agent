...
export function PremiumPortfolio() {
  ...
  return <main className="premiumPortfolioV2">
    ...
    <section className="premiumFinalCtaV2">
      <div><p className="premiumEyebrow">Ready for interview</p><h2>Need a Salesforce developer who understands CRM, code and business impact?</h2><p>Open the private Career OS for learning proof, interview preparation, job tracker and AI mentor dashboard.</p></div>
